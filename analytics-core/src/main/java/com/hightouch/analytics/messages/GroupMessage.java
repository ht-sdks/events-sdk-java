 ...
 *
 * @see <a href="https://hightouch.com/docs/spec/group/">Group</a>
 */
@AutoValue
@AutoGson //
public abstract class GroupMessage implements Message {
   ...
   * @see <a href="https://hightouch.com/docs/spec/group/#group-id">Group ID</a>
   */
  ...
  public static class Builder extends MessageBuilder<GroupMessage, Builder> {
     ...
     *
     * @see <a href="https://hightouch.com/docs/spec/group/#traits">Traits</a>
     */
