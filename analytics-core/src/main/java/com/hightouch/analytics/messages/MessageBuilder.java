package com.hightouch.analytics.messages;
...
public abstract class MessageBuilder<T extends Message, V extends MessageBuilder> {
   ...
   * @see <a href="https://hightouch.com/docs/spec/common/">Common Fields</a>
   */
   ...
   * historical import.
   *
   * @see <a href="https://hightouch.com/docs/spec/common/#-sentAt-">SentAt</a>
   */
   ...
   *
   * @see <a href="https://hightouch.com/docs/spec/common/#-timestamp-">Timestamp</a>
   */
   ...
   *
   * @see <a href="https://hightouch.com/docs/spec/common/#context">Context</a>
   */
   ...
   * @see <a href="https://hightouch.com/docs/spec/identify/#identities">Identities</a>
   * @see <a href="https://hightouch.com/docs/spec/identify/#anonymous-id">Anonymous ID</a>
   */
   ...
   *
   * @see <a href="https://hightouch.com/docs/spec/identify/#identities">Identities</a>
   * @see <a href="https://hightouch.com/docs/spec/identify/#user-id">User ID</a>
   */
   ...
   *
   * @see <a href="https://hightouch.com/docs/spec/common/#integrations">Integrations</a>
   */
