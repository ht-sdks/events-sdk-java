 ...
 *
 * @see <a href="https://hightouch.com/docs/spec/track">Track</a>
 */
@AutoValue
@AutoGson //
public abstract class TrackMessage implements Message {
   ...
   * @see <a href="https://hightouch.com/docs/spec/track/#event">Track Event</a>
   */
  ...
  public static class Builder extends MessageBuilder<TrackMessage, Builder> {
     ...
     *
     * @see <a href="https://hightouch.com/docs/spec/track/#properties">Properties</a>
     */
