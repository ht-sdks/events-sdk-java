 ...
 *
 * @see <a href="https://hightouch.com/docs/spec/page/">Page</a>
 */
@AutoValue
@AutoGson //
public abstract class PageMessage implements Message {
   ...
   * @see <a href="https://hightouch.com/docs/spec/page/#name">Page</a>
   */
  ...
  public static class Builder extends MessageBuilder<PageMessage, Builder> {
     ...
     *
     * @see <a href="https://hightouch.com/docs/spec/page/#properties">Properties</a>
     */
