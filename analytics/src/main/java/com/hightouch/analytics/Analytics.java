...
import com.hightouch.analytics.gson.AutoValueAdapterFactory;
import com.hightouch.analytics.gson.ISO8601DateAdapter;
import com.hightouch.analytics.http.HightouchService;
import com.hightouch.analytics.internal.AnalyticsClient;
import com.hightouch.analytics.internal.AnalyticsVersion;
...
/**
 * The entry point into the Hightouch for Java library.
 *
 * <p>The idea is simple: one pipeline for all your data. Hightouch is the single hub to collect,
 * translate and route your data with the flip of a switch.
 *
 * <p>Analytics for Java will automatically batch events and upload it periodically to Hightouch's
 * servers for you. You only need to instrument Hightouch once, then flip a switch to install new
 * tools.
 *
 * <p>This class is the main entry point into the client API. Use {@link #builder} to construct your
 * own instances.
 *
 * @see <a href="https://Hightouch/">Hightouch</a>
 */
public class Analytics {
   ...
   *
   * @param writeKey Your project write key available on the Hightouch dashboard.
   */
  public static Builder builder(String writeKey) {
    return new Builder(writeKey);
  }

  /** Enqueue the given message to be uploaded to Hightouch's servers. */
  ...
  public static class Builder {
    private static final String DEFAULT_ENDPOINT = "https://api.hightouch.io";
     ...
     * https://api.hightouch.io} by default.
     */
     ...
     * https://api.hightouch.io/v1} by default.
     */
    ...
    public Analytics build() {
      ...
      HightouchService hightouchService = restAdapter.create(HightouchService.class);
